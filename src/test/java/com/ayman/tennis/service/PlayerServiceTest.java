...
import com.ayman.tennis.data.PlayerEntityList;
...
public class PlayerServiceTest {
    ...
    public void shouldFailToRetrievePlayer_WhenPlayerDoesNotExist(){
        ...
        // When / Then
        Exception exception = assertThrows(PlayerNotFoundException.class, ()-> playerService.getByLastName(unknownPlayer));
        Assertions.assertThat(exception.getMessage()).isEqualTo("Player with the last name doe could not be found.");
    }
